...
public class Battleship extends GameObject {
    ...
    //rotation is final because it shouldn't be possible to change it after signing. It contains the rotation of the ship possible is 0 and 90.
    ...
    public Battleship(int pixelX, int pixelY, int rotation, ID id, Handler handler) {
        ...
        //Assigns the pixelX from the constructor to the pixelX parameter from the Battleship class.
        this.pixelX = pixelX;
        //Assigns the pixelY from the constructor to the pixelY parameter from the Battleship class.
        this.pixelY = pixelY;
        //Assigns the rotation from the constructor to the rotation parameter from the Battleship class.
