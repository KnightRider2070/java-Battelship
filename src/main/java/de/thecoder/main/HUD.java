...
public void tick() {
	...
	if(messageOne == null)
		messageOne = " "; if(messageTwo == null)
		messageTwo = " "; if(messageAll == null)
		messageAll = " ";
}
...
public void render(Graphics g) {
	...
	g.setColor(Color.GRAY); g.fillRect(50, 15, 170, 32); g.setColor(Color.BLUE);
	Font font = new Font("Ariel", Font.PLAIN, 25); g.setFont(font);
	g.drawString("Ships Alive: " + Game.getShipsAlivePlayerOne(), 55, 40);

	/*Player two info how many ships alive*/
	g.setColor(Color.GRAY); g.fillRect(1050, 15, 170, 32); g.setColor(Color.BLUE); g.setFont(font);
	g.drawString("Ships Alive: " + Game.getShipsAlivePlayerTwo(), 1055, 40);

	/*Player one message*/
	g.setColor(Color.CYAN); g.fillRect(50, 630, 400, 32); g.setFont(font); g.setColor(Color.BLACK);
	g.drawString("Message: " + messageOne, 55, 655);

	/*Player two message*/
	g.setColor(Color.GREEN); g.fillRect(1050, 630, 400, 32); g.setFont(font); g.setColor(Color.BLACK);
	g.drawString("Message: " + messageTwo, 1055, 655);

	/*All player message*/
	g.setColor(Color.ORANGE); g.fillRect(550, 630, 400, 40); g.setFont(font); g.setColor(Color.BLACK);
	...
	if(Game.STARTUP) {
		...
		if(HUD.arrayXset >= 1)
			...
			g.setColor(Color.red); g.fillRect(610, 520, 130, 30); g.setFont(font); g.setColor(Color.ORANGE);
		g.drawRect(610, 520, 130, 30); g.setColor(Color.BLACK); g.drawString("arrayX: " + arrayXset, 615, 542);

		/*ArrayY status message*/
		if(HUD.arrayYset >= 1)
			g.setColor(Color.green);
		else
			g.setColor(Color.red); g.fillRect(610, 570, 130, 30); g.setFont(font); g.setColor(Color.ORANGE);
		g.drawRect(610, 570, 130, 30); g.setColor(Color.BLACK); g.drawString("arrayY: " + arrayYset, 615, 592);

		/*Rotation status message*/
		if(HUD.rotationSet >= 1)
			g.setColor(Color.green);
		else
			g.setColor(Color.red); g.fillRect(760, 520, 130, 30); g.setFont(font); g.setColor(Color.ORANGE);
		g.drawRect(760, 520, 130, 30); g.setColor(Color.BLACK); g.drawString("rotation: " + rotationSet, 765, 542);

		/*ShipType status message*/
		if(HUD.shipTypeNow >= 1)
			g.setColor(Color.green);
		else
			g.setColor(Color.red); g.fillRect(760, 570, 130, 30); g.setFont(font); g.setColor(Color.ORANGE);
		g.drawRect(760, 570, 130, 30); g.setColor(Color.BLACK); g.drawString("ship: " + shipTypeNow, 765, 592);
	}
}
