...
public class Destroyer extends GameObject {
    ...
    public Destroyer(int pixelX, int pixelY, int rotation, ID id, Handler handler) {
        ...
        //Assigns the pixelX from the constructor to the pixelX parameter from the Destroyer class.
        this.pixelX = pixelX;
        //Assigns the pixelY from the constructor to the pixelY parameter from the Destroyer class.
        this.pixelY = pixelY;
        //Assigns the rotation from the constructor to the rotation parameter from the Destroyer class.
